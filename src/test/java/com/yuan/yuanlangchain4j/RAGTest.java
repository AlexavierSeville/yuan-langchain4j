...
public class RAGTest {
    ...
    public void testReadDocument() {
        ...
        // Document document = FileSystemDocumentLoader.loadDocument("D:\\JavaFiles\\yuan-langchain4j\\knowledge\\测试.txt");
        // System.out.println(document.text());

        // 加载单个文档
        Document document = FileSystemDocumentLoader.loadDocument("D:\\JavaFiles\\yuan-langchain4j\\knowledge\\测试.txt", new TextDocumentParser());
        // 从一个目录中加载所有文档
        List<Document> documents1 = FileSystemDocumentLoader.loadDocuments("D:\\JavaFiles\\yuan-langchain4j\\knowledge", new TextDocumentParser());
        // 从一个目录中加载所有的.txt文档
        PathMatcher pathMatcher = FileSystems.getDefault().getPathMatcher("glob:*.md");
        List<Document> documents2 = FileSystemDocumentLoader.loadDocuments("D:\\JavaFiles\\yuan-langchain4j\\knowledge", pathMatcher, new TextDocumentParser());
        ...
        // 从一个目录及其子目录中加载所有文档
        List<Document> documents3 = FileSystemDocumentLoader.loadDocumentsRecursively("D:\\JavaFiles\\yuan-langchain4j\\knowledge", new TextDocumentParser());
    }
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader
                .loadDocument(
                        "D:\\JavaFiles\\yuan-langchain4j\\knowledge\\yuan_hospital.pdf",
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("D:\\JavaFiles\\yuan-langchain4j\\knowledge\\yuan_hospital.md");
